...
AI models can access both private and public information. You can create "private" agents by giving a model documentation/sources to pull from. Private models are kinda like asking someone without internet access but their own private library something.

AI can quickly pull resources from the depths of the internet together. The content; however, remains to be judged. It also gives suggestions based on what information is online, sometimes worded exactly the same as the original source. 
